...
/* ----------------------------------------------------------------------------
 * 
 *   MakeLine() allocates the memory required for a TreePolyline and 
 *   initializes the fields of a TreePolyline to the arguments. The
   ...
   TreePolyline *link;
{
   ...
   new = (TreePolyline *) malloc(sizeof(TreePolyline));
...
{
   int x, y, total, d;
   TreePolyline *lower, *upper, *bridge;
